...
class SongFirebaseServiceImpl extends SongFirebaseService {
  ...
  Future<Either> getNewsSongs() async {
    try {
      ...
      var data = await FirebaseFirestore.instance
          .collection('Songs') // Ensure the collection name is correct
      ...
      return const Left('An error occurred. Try again later.');
    }
  }
    ...
    try {
      ...
      if (favoriteSongs.docs.isNotEmpty) {
        ...
        await firebaseFirestore
            ...
            .doc(uId)
            .collection('Favorites')
            .add({'songId': songId, 'addedTime': Timestamp.now()});
        isFavorite = true;
      }
      return Right(isFavorite);
    } catch (e) {
      return const Left('An error Occuredwhile adding to fav songs');
    }
  }
  ...
  Future<Either> getUserFavoriteSongs() async {
    try {
      ...
      return const Left('Erro Occured While fetching favorite songs');
    }
  }
}
